...
/// You can find and use on your Controller wich is the Controller extends [BaseController].
class ScreenState {
  State screenState = State.LOADING;
  State screenStateLoading = State.LOADING;
  State screenStateOk = State.OK;
  State screenStateError = State.ERROR;
  DioError? err ;
  String textError = "";
  State get getScreenState => screenState;

  set setScreenState(State event) => screenState = event;

  bool get screenStateIsLoading => screenState == screenStateLoading;

  bool get screenStateIsOK => screenState == screenStateOk;

  bool get screenStateIsError => screenState == screenStateError;
}