...
class CheckListFormControllerApi {

  final Dio _dio;

  final Serializers _serializers;

  const CheckListFormControllerApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<ChecklistForm>>> findAllUtilities1({ 
    String? formName = '',
    ...
    final _path = r'/api/v1/checkListFrom/';
