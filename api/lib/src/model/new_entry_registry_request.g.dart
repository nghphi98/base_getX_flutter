...
part of 'new_entry_registry_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$NewEntryRegistryRequest extends NewEntryRegistryRequest {
  @override
  final int? sponsorId;
  @override
  ...
  factory _$NewEntryRegistryRequest(
          [void Function(NewEntryRegistryRequestBuilder)? updates]) =>
      (new NewEntryRegistryRequestBuilder()..update(updates)).build();

  _$NewEntryRegistryRequest._(
      {this.sponsorId,
      this.description,
      this.earlyTime,
      this.locationIds,
    ...
    BuiltValueNullFieldError.checkNotNull(
        idNumber, 'NewEntryRegistryRequest', 'idNumber');
    BuiltValueNullFieldError.checkNotNull(
        name, 'NewEntryRegistryRequest', 'name');
    BuiltValueNullFieldError.checkNotNull(
        reason, 'NewEntryRegistryRequest', 'reason');
  }

  @override
  NewEntryRegistryRequest rebuild(
          void Function(NewEntryRegistryRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  NewEntryRegistryRequestBuilder toBuilder() =>
      new NewEntryRegistryRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is NewEntryRegistryRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('NewEntryRegistryRequest')
...
class NewEntryRegistryRequestBuilder
    implements
        Builder<NewEntryRegistryRequest, NewEntryRegistryRequestBuilder> {
  _$NewEntryRegistryRequest? _$v;
  ...
  NewEntryRegistryRequestBuilder() {
    NewEntryRegistryRequest._defaults(this);
  }

  NewEntryRegistryRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(NewEntryRegistryRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$NewEntryRegistryRequest;
  }

  @override
  void update(void Function(NewEntryRegistryRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$NewEntryRegistryRequest build() {
    _$NewEntryRegistryRequest _$result;
    try {
      _$result = _$v ??
          new _$NewEntryRegistryRequest._(
              sponsorId: sponsorId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'NewEntryRegistryRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
