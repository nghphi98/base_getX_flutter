...
part 'new_entry_registry_request.g.dart';
...
/// * [relativeTimeRange] 
/// * [pattern] 
abstract class NewEntryRegistryRequest implements Built<NewEntryRegistryRequest, NewEntryRegistryRequestBuilder> {
    ...
    NewEntryRegistryRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(NewEntryRegistryRequestBuilder b) => b;

    factory NewEntryRegistryRequest([void updates(NewEntryRegistryRequestBuilder b)]) = _$NewEntryRegistryRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<NewEntryRegistryRequest> get serializer => _$NewEntryRegistryRequestSerializer();
}

class _$NewEntryRegistryRequestSerializer implements StructuredSerializer<NewEntryRegistryRequest> {
    @override
    final Iterable<Type> types = const [NewEntryRegistryRequest, _$NewEntryRegistryRequest];

    @override
    final String wireName = r'NewEntryRegistryRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, NewEntryRegistryRequest object,
    ...
    @override
    NewEntryRegistryRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = NewEntryRegistryRequestBuilder();
