...
part 'new_landing_page_entry_registry_request.g.dart';
...
/// * [relativeTimeRange] 
/// * [pattern] 
abstract class NewLandingPageEntryRegistryRequest implements Built<NewLandingPageEntryRegistryRequest, NewLandingPageEntryRegistryRequestBuilder> {
    ...
    NewLandingPageEntryRegistryRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(NewLandingPageEntryRegistryRequestBuilder b) => b;

    factory NewLandingPageEntryRegistryRequest([void updates(NewLandingPageEntryRegistryRequestBuilder b)]) = _$NewLandingPageEntryRegistryRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<NewLandingPageEntryRegistryRequest> get serializer => _$NewLandingPageEntryRegistryRequestSerializer();
}

class _$NewLandingPageEntryRegistryRequestSerializer implements StructuredSerializer<NewLandingPageEntryRegistryRequest> {
    @override
    final Iterable<Type> types = const [NewLandingPageEntryRegistryRequest, _$NewLandingPageEntryRegistryRequest];

    @override
    final String wireName = r'NewLandingPageEntryRegistryRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, NewLandingPageEntryRegistryRequest object,
    ...
    @override
    NewLandingPageEntryRegistryRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = NewLandingPageEntryRegistryRequestBuilder();
