...
part of 'update_entry_registry_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$UpdateEntryRegistryRequest extends UpdateEntryRegistryRequest {
  @override
  final int? sponsorId;
  @override
  ...
  factory _$UpdateEntryRegistryRequest(
          [void Function(UpdateEntryRegistryRequestBuilder)? updates]) =>
      (new UpdateEntryRegistryRequestBuilder()..update(updates)).build();

  _$UpdateEntryRegistryRequest._(
      {this.sponsorId,
      this.description,
      this.earlyTime,
      this.locationIds,
    ...
    BuiltValueNullFieldError.checkNotNull(
        idNumber, 'UpdateEntryRegistryRequest', 'idNumber');
    BuiltValueNullFieldError.checkNotNull(
        name, 'UpdateEntryRegistryRequest', 'name');
    BuiltValueNullFieldError.checkNotNull(
        reason, 'UpdateEntryRegistryRequest', 'reason');
  }

  @override
  UpdateEntryRegistryRequest rebuild(
          void Function(UpdateEntryRegistryRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UpdateEntryRegistryRequestBuilder toBuilder() =>
      new UpdateEntryRegistryRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UpdateEntryRegistryRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UpdateEntryRegistryRequest')
...
class UpdateEntryRegistryRequestBuilder
    implements
        Builder<UpdateEntryRegistryRequest, UpdateEntryRegistryRequestBuilder> {
  _$UpdateEntryRegistryRequest? _$v;
  ...
  UpdateEntryRegistryRequestBuilder() {
    UpdateEntryRegistryRequest._defaults(this);
  }

  UpdateEntryRegistryRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(UpdateEntryRegistryRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UpdateEntryRegistryRequest;
  }

  @override
  void update(void Function(UpdateEntryRegistryRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$UpdateEntryRegistryRequest build() {
    _$UpdateEntryRegistryRequest _$result;
    try {
      _$result = _$v ??
          new _$UpdateEntryRegistryRequest._(
              sponsorId: sponsorId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'UpdateEntryRegistryRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
